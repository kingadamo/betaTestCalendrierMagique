...
class dayViewOther extends StatefulWidget {
  var eventsDetailled = [];
  var dateToShow;
  dayViewOther(this.eventsDetailled, this.dateToShow);
  @override
  _dayViewOtherState createState() => _dayViewOtherState(this.eventsDetailled, this.dateToShow);
}

class _dayViewOtherState extends State<dayViewOther> {
  DayViewController _controller = DayViewController();
  var eventsDetailled = [];
  var dateToShow;
  _dayViewOtherState(this.eventsDetailled, this.dateToShow);
  ...
  Widget build(BuildContext context) {
    ...
    HourMinute _heureMinimum = HourMinute(hour: 8, minute: 0);
    return Container(
      child: DayView(
