...
class tab1 extends StatefulWidget{
  ...
  tab1(this.events, this.selectedEvents, this.controller);
  @override
  _tab1State createState() => _tab1State(this.events, this.selectedEvents, this.controller);
}
...
class _tab1State extends State<tab1>{
  ...
  var selectedEvents = [];
  var controller = CalendarController();
  _tab1State(this.events, this.selectedEvents, this.controller);
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(
                            '${date.day}',
                            style:
                            TextStyle().copyWith(fontSize: 18.0),
                          ),
                          Icon(
